...
Pod::Spec.new do |s|
  s.name             = 'RXOpeninstallOSSDK'
  s.version          = '3.8.2'
  s.summary          = 'ruixue RXOpeninstallOSSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXOpeninstallOSSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXOpeninstallOSSDK.git', :tag => s.version.to_s }
